...
#include <TclElastomericBearingUFRPCommand.cpp>
#include <TclElastomericBearingPlasticityCommand.cpp>
#include <TclSingleFPCommand.cpp>
#include <TclFlatSliderCommand.cpp>
...
extern void *OPS_NewShellNLDKGT(void);   //Added by Lisha Wang, Xinzheng Lu, Linlin Xie, Song Cen & Quan Gu
			      ...
			      Domain *theTclDomain, TclModelBuilder *theTclBuilder)
{
  ...
  if ((strcmp(argv[1],"truss") == 0) || (strcmp(argv[1],"Truss") == 0)) {
    ...
    */
    ...
    void *theEle = OPS_NewShellNLDKGT();
    if (theEle != 0) 
      theElement = (Element *)theEle;
    else {
      opserr << "TclElementCommand -- unable to create element of type : " << argv[1] << endln;
